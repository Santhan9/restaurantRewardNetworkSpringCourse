...
public class RewardsConfig {
	...
	public RewardNetwork rewardNetwork(){
		System.out.println("Bean configuration for RewardNetwork");
	...
	public AccountRepository accountRepository(){
		System.out.println("Bean configuration for AccountRepository");
	...
	public RestaurantRepository restaurantRepository(){
		System.out.println("Bean configuration for RestaurantRepository");
	...
	public RewardRepository rewardRepository(){
		System.out.println("Bean configuration for RewardRepository");
